...
pub const MISSIONS: &[MissionDef] = &[
    ...
    MissionDef {
        ...
        challenge: "Run a workflow with 5 or more interconnected nodes",
    },
    MissionDef {
        ...
        icon: "◫",
        category: MissionCategory::Workflow,
        challenge: "Complete 10 full workflow executions",
    },
    MissionDef {
        ...
        icon: "◪",
        category: MissionCategory::Workflow,
        challenge: "Run a workflow with parallelizable specs enabled",
    },
    MissionDef {
        ...
        icon: "◯",
        category: MissionCategory::Workflow,
        challenge: "Execute 100+ individual workflow node runs",
    },
    MissionDef {
        ...
        challenge: "Create your first Seed Identity via the Nursery workflow",
    },
    MissionDef {
